...
const ReportIssue = () => {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        (err) => {
             ...
             if (err.code === 1) errorMsg = "Permission denied. Allow location access.";
             else if (err.code === 2) errorMsg = "Position unavailable.";
             else if (err.code === 3) errorMsg = "Timeout.";
             setError(errorMsg + " using default location. Please adjust manually.");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(`Failed to ${isEditMode ? "update" : "report"} issue (Status: ${status}). Details: ${msg}`);
    }
  };
  ...
  return (
    ...
    <Container className="report-issue-container">
      ...
      >
      <h2 className="mb-4">{isEditMode ? "Edit Issue" : "Report an Issue"}</h2>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group className="mb-3">
          ...
          />
          <Form.Text className="text-muted">Or click on the map below to set location</Form.Text>
        </Form.Group>
        ...
        <Form.Group className="mb-3">
          <Form.Label>{isEditMode ? "Upload New Image (Optional)" : "Upload Image"}</Form.Label>
          <Form.Control
            type="file"
          ...
          />
          <Form.Text className="text-muted">Max 5MB. Formats: JPG, PNG.</Form.Text>
        </Form.Group>
        
        <Form.Group className="mb-4">
             <div className="d-flex justify-content-between align-items-center mb-2">
                <Form.Label className="mb-0">Location (Click on map to adjust)</Form.Label>
                <Button 
                    ...
                    disabled={isLocating}
                >
                    {isLocating ? <><Spinner as="span" animation="border" size="sm" role="status" aria-hidden="true"/> Locating...</> : '📍 Use My Current Location'}
                </Button>
             </div>
